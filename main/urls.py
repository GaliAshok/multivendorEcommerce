...
urlpatterns = [
    ...
    path('vendor/<int:pk>/customer/<int:customer_id>/orderitems/', views.VendorCustomerOrderItemList.as_view()),    
    ...
    path('products/<str:tags>/', views.TagProductList.as_view()),
    ...
    path('product-img/<int:pk>/', views.ProductImgDelete.as_view()),
    ...
    path('customer/null', views.null_view, name='null_view'),
    ...
    path('update-order-status/<int:order_id>', views.update_oder_status, name='update_oder_status'),
    ...
    path('customer/<int:pk>/wishlistitems/', views.CustomerWishItemList.as_view()),   
